...
hi LineNr term=underline ctermfg=7 ctermbg=0 guifg=Red3
hi CursorLineNr term=underline ctermfg=1 ctermbg=0
hi Question term=standout ctermfg=7 gui=bold guifg=SeaGreen
